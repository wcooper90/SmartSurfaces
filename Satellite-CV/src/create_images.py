...
# class is from https://gist.github.com/eskriett/6038468
class GoogleMapDownloader:
    ...
    def __init__(self, lat, lng, zoom=UserInputs.DEFAULT_ZOOM):
        """
...
def create_images(long, lat, path, num):
    # Create a new instance of GoogleMap Downloader
    gmd = GoogleMapDownloader(long, lat)
